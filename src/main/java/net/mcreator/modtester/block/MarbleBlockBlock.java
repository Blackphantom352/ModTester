...
public class MarbleBlockBlock extends ModtesterModElements.ModElement {
	@ObjectHolder("modtester:marble_block")
	public static final Block block = null;
	public MarbleBlockBlock(ModtesterModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Made for Mom"));
		}
